select distinct childConcept.concept_id as id,childConcept.concept_full_name as name, childConceptRaw.is_set as isset,
 (case when (childConceptRaw.datatype_id = 2) THEN 1 ELSE 0 END) as coded,
